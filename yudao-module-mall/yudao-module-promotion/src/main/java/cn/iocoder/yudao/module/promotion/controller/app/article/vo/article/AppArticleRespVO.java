...
public class AppArticleRespVO {
    ...
    @Schema(description = "文章标题", requiredMode = Schema.RequiredMode.REQUIRED, example = "示例用户 - 促销模块")
    private String title;

    @Schema(description = "文章作者", requiredMode = Schema.RequiredMode.REQUIRED, example = "示例用户")
